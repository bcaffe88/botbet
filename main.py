...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("👋 Bot ativo com IA e polling!")

async def veredito_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("⚙️ Critérios Técnicos: IA, minuto, ataques, chutes no gol, escanteios, vento, histórico e posse.")

async def teste_ia(update: Update, context: ContextTypes.DEFAULT_TYPE):
    print("🟢 TESTEIA FOI ACIONADO!")
    await update.message.reply_text("🔍 Comando recebido.")
...
if __name__ == "__main__":
    ...
    app.add_handler(CommandHandler("veredito", veredito_cmd))

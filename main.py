...
async def analisar(texto):
    try:
        ...
        criterios, resumo_dados = [], []
        pontos = 0

        if ia and ia >= 75: pontos += 2; criterios.append("IA"); resumo_dados.append(f"• IA: {ia}%")
        if minuto and 16 <= minuto <= 22: pontos += 1
